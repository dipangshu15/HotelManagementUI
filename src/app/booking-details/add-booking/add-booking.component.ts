...
export class AddBookingComponent implements OnInit {
  ...
  onSubmit(){
    this.bdService.addBookingDetails(this.bookingDetailsForm.value).subscribe(response=>{console.log('Success!',response);alert("Success!")},error=>console.error('Error!',error));
  }
